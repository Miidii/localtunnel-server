...
let tunnelPortOffset = 0;
const MAX_NUM_TUNNEL_PORTS = 10;
...
const Proxy = function(opt) {
    ...
    // tunnel port
    self.tunnel_port = opt.tunnel_port;
...
Proxy.prototype.start = function(cb) {
    ...
    const tunnelPort = self.tunnel_port + tunnelPortOffset;
    tunnelPortOffset = (tunnelPortOffset + 1) % MAX_NUM_TUNNEL_PORTS;
